...
with(pdata, plot(Timestamp, Sub_metering_1, type="n", xlab="", ylab="Energy sub metering"))                    
with(pdata, points(Timestamp, Sub_metering_1, type="l", col = "black"))
with(pdata, points(Timestamp, Sub_metering_2, type="l", col = "red"))
with(pdata, points(Timestamp, Sub_metering_3, type="l", col = "blue"))
